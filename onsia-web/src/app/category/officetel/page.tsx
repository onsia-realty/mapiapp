    ...
    <MobileLayout>
      <header className="sticky top-0 z-10 bg-white shadow-sm">
        <div className="flex items-center gap-3 px-5 py-4">
          ...
          <h1 className="text-lg font-bold text-gray-900">오피스텔</h1>
        </div>
        ...
        <div className="flex gap-2 px-5 pb-3">
          <button
            ...
            className={`px-4 py-2 text-sm rounded-full font-medium ${
              selectedType === "SALE" ? "bg-green-600 text-white" : "bg-gray-100 text-gray-600"
            }`}
          >
            매매
          </button>
          <button
            ...
            className={`px-4 py-2 text-sm rounded-full font-medium ${
              selectedType === "RENT" ? "bg-green-600 text-white" : "bg-gray-100 text-gray-600"
            }`}
          >
            전세
          </button>
          <button
            ...
            className={`px-4 py-2 text-sm rounded-full font-medium ${
              selectedType === "MONTHLY" ? "bg-green-600 text-white" : "bg-gray-100 text-gray-600"
            }`}
          >
            월세
          </button>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm font-bold text-green-600">{item.monthlyRent}만</div>
                      </div>
                    </div>
                  </div>
                </div>
